...
- 技术教程先以目标技术的最新官方文档、官方 API 参考和官方版本说明为事实依据，再使用社区文章补充实践经验。
- 社区文章与官方文档冲突时，以最新官方文档为准；社区资料只能作为示例、经验或中文解释，不能覆盖官方 API 行为。
- 如果项目锁定旧版本，使用该版本对应的官方文档，并明确说明与最新版本的差异；不要把最新 API 直接套到旧依赖上。
- 如果用户界面、官方文档和实际运行结果不一致，记录产品/依赖版本、文档更新时间和截图或错误现象，先核对官方 changelog、release 或 issue，再判断是否是版本差异；不要把社区旧教程当作当前行为。
- 教程引用社区内容时标注版本和来源；无法确认版本的社区文章只能列为“补充参考”，不能作为本章必须掌握的依据。
