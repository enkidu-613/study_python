...
description: "Firecrawl 网页研究与 Karpathy 风格 AI 工程准则。Use when researching websites, docs, APIs, products, or technical topics with scrape/crawl/map/search/extract workflows and when outputs should be source-grounded, small-step, verifiable, and implementation-ready."
---

# Firecrawl Karpathy Research

用于把网页、文档、API 或产品资料整理成可靠的工程上下文。优先官方/一手来源，保留 URL，并区分事实、推断和建议。
